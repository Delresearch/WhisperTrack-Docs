...
Fontus Acoustic Messages (**FAMs**) are the standardized 64-bit packets used in the FONTUS underwater acoustic communication protocol. All messages follow the format defined in the [Fontus Bit Definitions Specification v1.0](../assets/files/fontus_bit_definitions_v1.0.pdf).
